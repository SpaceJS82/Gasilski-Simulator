...
public class FirePopupWindow extends Window {
    ...
    public FirePopupWindow(FirePoint firePoint, Skin skin) {
    ...
    private void setupUI(Skin skin) {
        ...
        contentTable.add(durationLabel).left().padBottom(15).row();
        
        // Create button
        TextButton putOutButton = new TextButton("PUT OUT THE FIRE!", skin);
